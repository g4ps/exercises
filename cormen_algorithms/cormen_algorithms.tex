...
Done it in the progs section; long story short: reverse the ordering function in inner loop,
...
\textit{Write pseudocode for linear search, which scans through the array from beginning to
  end, looking for $x$. Using a loop invariant, prove that youralgorythm is correct.
...
%   \end{function}
%   TODO : maybe add pseudocode here
