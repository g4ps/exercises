...
% Suppose that $u \in U$. Then it follows that $\phi \in U^0 \to \phi(u) = 0$. Thus we've got that
% $U \subseteq  \{v \in V: \phi(v) = 0 \text{ for every } \phi \in U^0 \}$.

% Conversely, let $v \in  \{v \in V: \phi(v) = 0 \text{ for every } \phi \in U^0 \}$ and
% suppose that $v \notin U$. Then we can follow that 
