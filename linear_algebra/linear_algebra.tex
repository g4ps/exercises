...
Plug in the vector $(\sum{A_{1, j}}, \sum{A_{2, j}}, ... \sum{A_{n, j}})$ into the vector

$$\sum{a_j A_{1, j}} = a_j$$

% \subsection{}

% \textit{Suppose $T \in \map(V)$ and $u, v$ are eigenvalues of $T$ such that $u + v$ is also an
%   eigenvector of $T$. PRove that $u$ and $v$ are eigenvalues of $T$ corresponding to the same
%   eigenvalue.}
