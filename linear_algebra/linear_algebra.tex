...
Suppose that $ST = TS$ for every $S \in \map(V)$. Suppose that $T$ is not a scalar multiple
of the identity. Then there exists $v \in V$ such that $Tv \neq \lambda v$ for some
$\lambda \in F$. Because of this we can follow that
