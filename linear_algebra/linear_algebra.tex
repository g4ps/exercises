...
Let $x \in A$ and suppose that $v, w \in A$. Then it follows that
$$ \lambda(v  - x) = \lambda v  - \lambda x =
\lambda v  - \lambda x + x - x =
(\lambda v  - (1 - \lambda) x) - x = 
$$
Thus space $A - x$ is closed under multiplication. And

$$(v - x) + (w - x) = \lambda v + (1 - \lambda)w - x$$
$$(v - x) + (w - x) = \lambda v + (1 - \lambda)w - x + x - x$$
$$(v - x) + (w - x) = \lambda v + w - \lambda w  - x + x - x$$
$$(v - x) + (w - x) = \lambda v - x + w - x - \lambda w + x $$
