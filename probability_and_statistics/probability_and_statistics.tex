...
Sample space is a set of outcomes.

Event is a subspace of a sample space.
...
\end{enumerate}
then $f$ is called a probability measure, or just measure. Canonical representation of
...
and general notes from the internet.
