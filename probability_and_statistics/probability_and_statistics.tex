...
\item $f(S) = 1$
\item if $A_n$ is an indexed set of disjoint events, then 
...
(in the book, definition of probability is somewhat unintuitive, but the not just below the
...
\section{The Expectation of a Random Variable}
