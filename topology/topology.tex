...
will be $x$, thus provind that singletons in $R^\omega$ in box topology are $G_\sigma$. Thus
we need to prove that $R^\omega$ is not first countable (if it is, obviously).

Let $B$ be a countable collection of neighborhoods of $x$ such that every neighborhood of $x$
contains at least one elememt of $B$. TODO
