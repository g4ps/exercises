...
Now the fact that $p\inv[\set{y}]$ is closed, fact that $X$ is normal, and the fact $U$
is an open set that contains $p\inv[\set{y}]$ all imply that there's an open set $W'$ such that
$W' \subseteq U \subseteq X$. We now follow that $X \setminus U$ is closed and thus
...
$p\inv(y) \notin X \setminus U$ and $p\inv(y) \in U$. Now since $y$ is arbitrary we follow that
...
Let $y_1, y_2 \in Y$ be such that $y_1 \neq y_2$. We follow that since $p$ is surjective there are
$x_1, x_2 \in X$ such that $x_1 \neq x_2$ by basic properties of functions.  
