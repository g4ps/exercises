...
Let $U$ be a collection of basis neighborhoods around $a$ defined by
$$U_\epsilon = B(x, \epsilon)$$
for all $\epsilon > 0$. We follow that $U$ is a open cover of $A$, and thus it's got a finite
subcover.

\textbf{This is wrong reasoning; needs work}
