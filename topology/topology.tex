...
If $g_1 \neq g_2$, then we follow that there exists $a \in \overline{A}$ such that
$g_1(a) \neq g_2(a)$. Since $f \subseteq g_1, g_2$, we follow that $a \notin A$. Thus we follow that
$a$ is a limit point of $A$. We follow that $g_1(a), g_2(a) \in Y$, and because
$Y$ is Hausdorff, we follow that there exist two disjoint neighborhoods $U, V \subseteq Y$
of $g_1(a)$ and $g_2(a)$ respectively. Since both $g_1, g_2$ are continous, we follow that
$g_1\inv[U]$ and $g_2\inv[V]$ are neighborhoods of $a$.

We follow that $U \cap A$ and $V \cap A$ are open and disjoint. Thus
we follow that $f\inv[U \cap A]$ and $f\inv[V \cap A]$ are disjoint and open. 

We follow that
$$g_1(\overline{A}) \subseteq \overline{g_1(A)} = \overline{f(A)}$$
thus we follow that $\ran(g_1), \ran(g_2) \subseteq \overline{f(A)}$. Thus $U$ and
$V$

\textit{TODO: finish this thing}
