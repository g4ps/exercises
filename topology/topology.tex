...
Suppose that there's a compact subspace of $\prod{X_\alpha}$ that contains $b$ and is a superset of $U$.
We then can follow pretty easily  that this would give us that $X_n$ is compact, which
is a contradiction. 
