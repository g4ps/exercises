...
one point. We can follow that it's Lindelof and thus every open cover of $X$
has a countable subcover. Let $x \in X$ and let $K \subseteq X$ be a closed subspace of $X$.
We follow that 
