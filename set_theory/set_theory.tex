...
Given that codomains of both $H$ and $H^*$ are oridnals, we follow that
there are 3 possible situations: $H(u) \in H^*(f(u))$,
$H(u) = H^*(f(u))$ or $H^*(f(u)) \in H(u)$. Suppose that latter holds.
We follow that TODO
