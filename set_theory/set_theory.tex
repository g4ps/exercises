...
Suppose that $\beta$  is not a limit ordinal. Then we follow that
$\beta = \gamma^+$ for some ordinal $\gamma$. Thus we follow that
$\beta = \gamma \cup \set{\gamma}$. Therefore $\sup \beta = \bigcup{\beta} = 
