...
Then we follow that $f_1 \neq f_2 \ra A_{f_1} \neq A_{f_2}$. Thus given function is injective.
Surjectivity of this function is pretty evident as well. Thus we follow that
there exists a bijection $A$ between two sets and thus
$$|\omega^\omega| =_c |\pow(\omega)|$$
as desired.
