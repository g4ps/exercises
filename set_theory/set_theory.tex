...
Suppose that $n = n^+$. Then we follow that $n \in n^+$, and therefore $n \in n$, which is
impossible.
...
Suppose that $m \in n$ and $n \subseteq m$. Then we follow that $m \in m$, which is impossible by
regularity axiom.
...
This is true for any set, not just elements of $\omega$.
...
Define
$$I = \{n \in \omega: m^+ \cdot n = m \cdot n + n\}$$.
Then we follow that $m^+ \cdot n = 0 = 0 + 0 = m \cdot 0 + 0$. Thus $0 \in I$.

Suppose that $n \in I$. Then we follow that
$$m^+ \cdot n^+ = m^+ \cdot (n + 1) = m^+ \cdot n + m^+ = m \cdot n + m + n + 1 $$
