...
Suppose that $x, y \in \omega$ and $h(x) = h(y)$. Then we follow that
$h[x] = h[y]$, thus $A \setminus h[x] = A \setminus h[y]$.
Since $h(x) \in A \setminus h[y]$. 
$$g(A \setminus h[x]) = g(A \setminus h[y])$$
Then we follow that $g(A \setminus h[x]) \in A \setminus h[x]$ and
$g(A \setminus h[y]) \in A \setminus h[y]$.
Thus $h(x) \in A \setminus h[x]$. 
TODO
